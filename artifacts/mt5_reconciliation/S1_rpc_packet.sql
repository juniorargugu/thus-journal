...
--   = sha256('mt5_s1_append_only_rpc_v1|packet-revision-5')
--   A DETERMINISTIC PACKET REVISION TOKEN, not a hash of this .sql file's bytes. It only makes
--   packet revisions distinguishable in the ledger and pins this packet to the revision-5 schema
...
begin
  ...
  if not found or v_schema.status <> 'applied'
     or v_schema.checksum <> '7cd1e9783853798e31f907cf567cfdfb0b90071427fa4132d56eb177a948139b'
...
insert into public.mt5_schema_migrations(
  ...
  -- packet identity token = sha256('mt5_s1_append_only_rpc_v1|packet-revision-5'); NOT a file hash
  '65a21a632f3826f661de6ce516cf804272a26ccea35275bde99b3b225953c835',
  '9902B301B3E170A7FD5AA348C9892395CEBEE129DF1B5F63FAB9F62D53CA266D',
  'applied',
  pg_catalog.jsonb_build_object(
    'connector_rpcs',8,'browser_rpcs',1,'internal_helpers',3,'source_revision',3,'packet_revision',5,
