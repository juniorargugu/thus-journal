...
| **B** | G2 grouping | Live write-gate browser smoke **PASS WITH ROLLBACK** (`f49056fa` created→ungrouped); DB safe (0 active / 0 grouped, 1 archived); UI + isMerged exclusion deployed default-off | Group-aware loader/render **design** (before keeping real groups) | design review; flag enable = user approval |
